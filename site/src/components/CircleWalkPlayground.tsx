    ...
    <div className="bg-stone-100 rounded-lg p-4 sm:p-6 border border-stone-200">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Shadow View (Default) - tilted circle with digit shadow line */}
          {!showBlockLayer && !showCosetComparison && (
            <div className="flex flex-col items-center">
              {/* Tilted circle container */}
              ...
              {/* Light ray (subtle, current only) */}
              <svg viewBox="0 0 200 40" className="w-56 sm:w-64 h-8 -mt-4">
                {currentRemainder && (
                  <line
                    x1={getPosition(currentRemainder).x}
                    y1="0"
                    x2={100}
                    y2="40"
                    stroke="#a5b4fc"
              ...
              {/* Shadow line (digit strip) - grouped by blockSize */}
              ...
              {/* Legend for shadow view */}
              <div className="text-[9px] sm:text-[10px] font-mono text-stone-500 mt-3 flex flex-wrap gap-3 justify-center">
