...
| `GeometricStack/OrbitBufferDuality.agda` | `digitAt-periodic` | `intentionally postulated but Lean-backed` | `GeometricStack.OrbitBufferDuality.digitAt_periodic` | `-` | Exact digit periodicity theorem is already proved in Lean. |
